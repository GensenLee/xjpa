 ...
 * @description 读取请求
 */
public class GroupingReadQueryRequest implements QueryRequest {

    private final GroupByInQuery query;

    private final TableProperties<?, ?>  tableProperties;

    public GroupingReadQueryRequest(GroupByInQuery query, TableProperties<?, ?> tableProperties) {
        this.query = query;
