...
import com.glee.xjpa.join.DefaultJoiningTableRepository;
...
import com.glee.xjpa.repository.impl.RepositoryContextAttribute;
import com.glee.xjpa.repository.impl.RepositoryContextObserver;
import com.glee.xjpa.sql.executor.SortType;
import com.glee.xjpa.sql.executor.session.DataSourceExecuteSession;
...
public class StandardJpaRepositoryProxyImpl<K extends Serializable, V> implements StandardJpaRepository<K, V>, RepositoryContext<K, V> {
    ...
    public int update(String column, String operateColumn, Object operateValue, UpdateOperator updateOperator) {
        return enhanceCurdRepository.update(column, operateColumn, operateValue, updateOperator);
    }
    ...
    public int add(String column, Object operateValue) {
        return enhanceCurdRepository.add(column, operateValue);
    }

    @Override
    public int add(String column, String operateColumn, Object operateValue) {
        return enhanceCurdRepository.add(column, operateColumn, operateValue);
    }

    @Override
    public int subtract(String column, Object operateValue) {
        return enhanceCurdRepository.subtract(column, operateValue);
    }

    @Override
    public int subtract(String column, String operateColumn, Object operateValue) {
        return enhanceCurdRepository.subtract(column, operateColumn, operateValue);
    }

    @Override
    public int multiply(String column, Object operateValue) {
        return enhanceCurdRepository.multiply(column, operateValue);
    }

    @Override
    public int multiply(String column, String operateColumn, Object operateValue) {
        return enhanceCurdRepository.multiply(column, operateColumn, operateValue);
    }

    @Override
    public int divide(String column, Object operateValue) {
        return enhanceCurdRepository.divide(column, operateValue);
    }

    @Override
    public int divide(String column, String operateColumn, Object operateValue) {
        return enhanceCurdRepository.divide(column, operateColumn, operateValue);
    }
